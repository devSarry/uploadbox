<section id="servicesPiece" data-nav="menu-our-services" class="servicesPiece" style="min-height: 741px;">
    <div class="wrap container">
        <div class="page-header">
            <h1>Our Services $data['settings]->services->heading</h1>
        </div>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="singleService">
                    ...
                    <div class="serviceItem clearfix"><span class="serviceName serviceItemPiece">Mens Haircut</span><span
            ...
            <div class="col-sm-6">
                <div class="singleService">
                    ...
                    <div class="serviceItem clearfix"><span
                                ...
                                class="servicePrice serviceItemPiece">$75+</span></div>
                    <div class="serviceItem clearfix"><span class="serviceName serviceItemPiece">Eyelash Tint</span><span
                                class="servicePrice serviceItemPiece">$35+</span></div>
                    <div class="serviceItem clearfix"><span class="serviceName serviceItemPiece">Eyebrow Tint</span><span
                                class="servicePrice serviceItemPiece">$25+</span></div>                <span
                            class="small">
